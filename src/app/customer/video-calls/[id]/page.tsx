...
export default function CustomerVideoCallInterfacePage() {
  ...
  const handleEndCall = async () => {
    ...
    if (result.error) {
      ...
      router.push('/customer/video-calls/history')
    }
  }
      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <Card className="max-w-md">
          <CardContent className="pt-6">
            ...
            <Button onClick={() => router.push('/customer/video-calls/history')}>
              Back to History
            </Button>
          </CardContent>
        </Card>
    ...
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute top-0 left-0 right-0 p-4 bg-gradient-to-b from-black/70 to-transparent">
            ...
            <div>
              <h2 className="font-semibold">Video Call - {callDetails.call_type}</h2>

...
export default function CustomerVideoCallHistoryPage() {
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">View your past and upcoming video consultations</p>
          </div>
          <Link href="/customer/video-calls/schedule">
            <Button>+ Schedule New Call</Button>
          </Link>
        </div>
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex-1">
                <Input
                  type="search"
                  placeholder="Search by call type or service request ID..."
                  value={searchTerm}
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex flex-col gap-2">
                      {call.status === 'scheduled' && isUpcoming(call.scheduled_for) && (
                        <Link href={`/customer/video-calls/${call.id}`}>

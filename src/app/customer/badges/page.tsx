...
import { getUserBadges, getUserAchievements } from '@/app/actions/gamification'
    ...
    <div className="min-h-screen bg-primary-50 py-10 px-4">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="flex gap-2 border-b">
          ...
          >
            Achievements ({achievements.filter(a => a.completed_at).length}/{achievements.length})
          </button>
        </div>
              ...
              <Card>
                <CardContent className="pt-6">
                  <p className="text-sm text-muted-foreground text-center">
                    Complete services to earn your first badge!
                  </p>
                </CardContent>
              </Card>
            ) : (

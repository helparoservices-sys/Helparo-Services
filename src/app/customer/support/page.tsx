...
export default function CustomerSupportPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-3 py-4 space-y-4">
      {/* Hero Header */}
      <div className="relative overflow-hidden bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 rounded-2xl p-5 md:p-8 text-white">
        ...
        <div className="relative">
          <div className="flex items-center gap-2 mb-3">
            ...
            <div className="px-2.5 py-1 bg-white/20 backdrop-blur-sm rounded-full text-xs font-semibold">
              24/7 Support
            </div>
          </div>
          <h1 className="text-2xl md:text-4xl font-black mb-1">Support Center</h1>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl font-semibold shadow-md text-sm"
      >
      ...
      <div className="flex gap-3 overflow-x-auto pb-1 -mx-3 px-3 scrollbar-hide">
        <div className="flex-shrink-0 w-[110px] md:w-auto md:flex-1 bg-white rounded-xl p-3 md:p-5 shadow-sm border border-gray-100">
      ...
      <div className="bg-white rounded-xl p-3 md:p-4 shadow-sm border border-gray-100 space-y-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border-0 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all"
          />
        </div>

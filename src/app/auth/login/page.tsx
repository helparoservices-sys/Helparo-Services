...
export default function LoginPage() {
  ...
  // White status bar to match the light login page
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-emerald-50/30 flex overflow-hidden">
      <div id="recaptcha-container"></div>
      
      {/* Left Side - Branding & Features (Hidden on mobile) */}
      <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] relative overflow-hidden flex-shrink-0">
        {/* Background Pattern */}

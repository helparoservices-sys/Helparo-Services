...
import { Loader2, ArrowLeft, ArrowRight, Shield, Star, Sparkles, Phone, RefreshCw, AlertCircle, Clock, Mail, Lock, Eye, EyeOff } from 'lucide-react'
...
export default function LoginPage() {
  ...
  const handleEmailLogin = async () => {
    ...
    try {
      ...
      if (!response.ok || result.error) {
        logger.error('Email login failed', { error: result.error })
        setError(result.error || 'Login failed. Please try again.')
      ...
      logger.error('Email login error', { error: err })
                ...
                {step === 'phone' && loginMethod === 'email' ? (
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full h-14 pl-12 pr-4 bg-white border border-gray-200 rounded-xl text-base text-gray-900 placeholder-gray-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none transition-all"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full h-14 pl-12 pr-12 bg-white border border-gray-200 rounded-xl text-base text-gray-900 placeholder-gray-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none transition-all"
                          onKeyDown={(e) => {
                            if (e.key === 'Enter') {
                              handleEmailLogin()
                            }
                    ...
                    <button
                      ...
                      disabled={!email || !password || emailLoading || navigating}
                    ...
                    >
                      {(emailLoading || navigating) ? (
                        <>
                          <Loader2 className="w-5 h-5 animate-spin" />
                          <span>{navigating ? 'Redirecting...' : 'Signing in...'}</span>
                        </>
                      ) : (
                        <>
                          <span>Sign In</span>

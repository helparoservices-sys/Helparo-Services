            ...
            {loginMethod === 'email' && (
              <>
                ...
                <button
                  ...
                  className="w-full h-12 lg:h-14 flex items-center justify-center gap-3 bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-gray-300 rounded-xl lg:rounded-2xl font-semibold text-sm lg:text-base text-gray-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                >
                  {googleLoading ? (
...
*/}
                ...
                {step === 'phone' ? (
                  <div className="space-y-5">
                    ...
                    <button
                      ...
                      className="w-full h-12 flex items-center justify-center gap-3 bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-gray-300 rounded-xl font-semibold text-gray-700 transition-all disabled:opacity-50"
                    >
                      {googleLoading ? (
                        <Loader2 className="w-5 h-5 animate-spin text-gray-500" />
                      ) : (
            ...
            <p className="text-center text-[11px] lg:text-xs text-gray-400 mt-4 lg:mt-6">
            ...
            <LegalModal type="terms" audience="customer" open={showTerms} onOpenChange={setShowTerms} />
            <LegalModal type="privacy" audience="customer" open={showPrivacy} onOpenChange={setShowPrivacy} />
          </div>
        </div>
